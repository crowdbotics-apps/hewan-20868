...
admin.site.site_header = "hewan"
admin.site.site_title = "hewan Admin Portal"
admin.site.index_title = "hewan Admin"

# swagger
api_info = openapi.Info(
    title="hewan API",
    default_version="v1",
    description="API documentation for hewan App",
)
